  ...
  theme: {
    extend: {
      colors: {
        ...
        // Brand aliases. `gold` follows the accent token so it flips correctly
        // inside `.on-dark`; the other two are fixed brand values.
        gold: withAlpha('accent'),
        'gold-ink': 'rgb(var(--gold-ink) / <alpha-value>)',
        'gold-wash': 'rgb(var(--gold-wash) / <alpha-value>)',
      },
      fontFamily: {
